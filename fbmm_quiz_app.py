...
def main():
    ...
    # Then center the intro manually
    st.markdown("<h1>Which FBMM Owner Are You?</h1>", unsafe_allow_html=True)
    st.markdown(
        "<div style='text-align:center;'>You know which team you're on. But which owner are you most like? Find out!</div>",
        unsafe_allow_html=True
    )
    ...
    if st.session_state.result_owner:
        ...
        st.write("Thanks for taking the quiz! If there are any questions or concerns, please reach out to angela_agiro@fbmm.com or beema_rajan@fbmm.com.")
