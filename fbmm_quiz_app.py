...
def main():
    ...
    def render_question(question_title, answer_image_map, key_prefix, owner_map):
        ...
        options = list(answer_image_map.keys())
        selected_answer = st.selectbox("Select an answer:", options, key=key_prefix)

        if selected_answer:
            if answer_image_map[selected_answer]:
                st.image(GITHUB_IMAGE_BASE_URL + answer_image_map[selected_answer], width=200)
    ...
    render_question(
        "Question 2: Who was your childhood crush?",
        {
            ...
            "Lindsey Lohan": "Lindsay_Lohan.jpg",
            ...
            "Rick Springfield": "Rick_Springfield.jpg",
            "The Bionic Woman": "The_Bionic_Woman.jpg"
        },
        "q2",
        {
            "Jaclyn Smith": ["Carmen"],
    ...
    render_question(
        ...
        {
            "Cabernet / a good red wine": "cabernet.jpg",
    ...
    if st.button("Submit"):
        ...
        st.image(OWNER_IMAGE_URLS[result])
